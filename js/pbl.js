	...
	window.onscroll = function(){
		...
		if(getCheck()){
			...
			for(i in data){
				...
				img.src = '/mobile-gallary-demo/resource/image/homeimage/'+data[i].src;
				...
				span.className = "pic_mark";
				span.innerHTML = '<i class="fa fa-heart"></i> 2 <i class="fa fa-comment-o"></i> 8';
